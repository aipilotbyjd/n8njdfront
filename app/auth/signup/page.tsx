      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-glass backdrop-blur-xl rounded-3xl p-10 border border-white/10 shadow-2xl shadow-[#607AFB]/20">
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl font-bold text-white mb-3 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Create Account</h1>
            <p className="text-gray-400 text-lg">Start automating your workflows today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="group">
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-gray-500 text-xl group-focus-within:text-[#607AFB] transition-colors">person</span>
                <input
                  type="text"
                  value={formData.name}
            ...
            <label className="flex items-start gap-3 cursor-pointer group pt-2">
              <input type="checkbox" required className="w-4 h-4 mt-1 rounded bg-white/5 border-white/10 accent-[#607AFB]" />
              <span className="text-gray-400 text-sm group-hover:text-gray-300 transition-colors">
                I agree to the{' '}
                <Link href="#" className="text-[#607AFB] hover:text-[#8B5CF6] transition-colors font-medium">
                  Terms of Service
                </Link>
                {' '}and{' '}
                <Link href="#" className="text-[#607AFB] hover:text-[#8B5CF6] transition-colors font-medium">
